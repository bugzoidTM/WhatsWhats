...
4. Quando aparecer a mensagem **"Acesse http://localhost:3000"**, está pronto!
5. **Deixe essa janela aberta** — fechar ela desliga o chatbot

---

## PASSO 3.5: Criar sua senha de acesso (apenas na primeira vez)

1. Abra o navegador e acesse **http://localhost:3000**
2. Você será redirecionado automaticamente para a tela de **configuração inicial**
3. Digite uma **nova senha** de sua escolha (mínimo 6 caracteres)
4. Confirme a senha e clique em **"Criar senha e entrar"**
5. Pronto — você entra direto no painel!

> **Na próxima vez:** ao abrir o sistema, você verá apenas a tela de login — sem precisar criar senha novamente.

> **Como trocar a senha:** No painel principal, clique no botão **"🔑 Senha"** no canto superior direito.

> **Esqueceu a senha?** Delete o arquivo `auth.json` da pasta do projeto e reinicie o `INICIAR.bat`. A tela de criar senha aparecerá novamente.
...
| Página de login não aparece | Aguarde alguns segundos e recarregue. Verifique se a janela do `INICIAR.bat` está aberta |
| Senha não funciona | Verifique se copiou corretamente do console. Maiúsculas/minúsculas importam |
| Esqueceu a senha | Delete o arquivo `auth.json` na pasta do projeto e reinicie o `INICIAR.bat` |
